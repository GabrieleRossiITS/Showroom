...
function ArtworkDetail() {
    ...
    return (
        <div className="relative bg-background overflow-hidden">
            ...
            <div className="fixed top-[-10%] right-[-5%] w-[50%] h-[50%] rounded-full bg-(--burnished-copper)/10 blur-[150px] pointer-events-none z-0" />
            <div className="fixed bottom-[-10%] left-[-5%] w-[60%] h-[60%] rounded-full bg-(--parisian-stone)/10 blur-[180px] pointer-events-none z-0" />
